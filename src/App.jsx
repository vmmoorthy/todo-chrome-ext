        ...
        <div className="bg-[#222222] w-full h-screen grid grid-flow-row grid-rows-[.8fr_9.2fr]">
            ...
            <div className="w-full  grid grid-flow-col grid-cols-[19fr_1fr]">
                ...
                <div className="grid  grid-flow-col m-1 p-4 gap-4 h-[80%] overflow-auto">
                    <div className="rounded-[20px] w-80 m-2 text-white bg-[#8D3DAF]">
                        <h1 suppressContentEditableWarning contentEditable className="title font-bold text-3xl p-2">
                            Title
                        </h1>
                    ...
                    <div className="rounded-[20px] w-80 m-2  bg-[#E07C24]"></div>
                    <div className="rounded-[20px] w-80 m-2  bg-[#8D3DAF]"></div>
                    <div className="rounded-[20px] w-80 m-2  bg-[#E07C24]"></div>
                    <div className="rounded-[20px] w-80 m-2  bg-[#8D3DAF]"></div>
                    <div className="rounded-[20px] w-80 m-2  bg-[#E07C24]"></div>
                    <div className="rounded-[20px] w-80 m-2  bg-[#8D3DAF]"></div>
                ...
                <div className="bg-[#23C4ED] border-white overflow-auto border-solid rounded-[18px] border-[1px] max-w-10 p-2 h-[95%] mr-2">
                    {/* notes */}
                    <div tabIndex={0} className="icon p-2 py-7 w-full my-2  rounded-[18px] h-[50px] flex justify-center items-center hover:bg-[#46B2E0] cursor-pointer focus:bg-[#1B98F5]">
